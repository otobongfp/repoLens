      ...
      <form onSubmit={handleSubmit} className='space-y-3'>
        <div>
          ...
          <input
            ...
            className='focus:outline-hidden focus:ring-primary w-full rounded-md border border-gray-300 px-3 py-2 text-gray-800 focus:border-transparent focus:ring-2'
          />
        </div>
