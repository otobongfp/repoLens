...
import { ArrowRight, Github, BookOpen, Info } from 'lucide-react';
      ...
      <div className='flex flex-col items-center justify-center gap-4'>
        ...
        <div className='flex flex-wrap items-center justify-center gap-3 sm:gap-4'>
          <Reveal delay={0.6}>
            <Link
              href='/about'
              className='border-border bg-card text-card-foreground hover:bg-accent hover:text-accent-foreground flex items-center gap-2 rounded-lg border px-4 py-2 text-sm font-medium transition sm:px-6'
            >
