/**
 * RepoLens Frontend - Heatmapview Component
 * 
...
export default function HeatmapView() {
  ...
  return (
    <div className='py-4'>
      <h2 className='text-primary mb-4 text-xl font-bold'>Code Heatmap</h2>
      ...
      {selectedNode && (
        <div className='mb-4 rounded-sm border border-white/10 bg-white/5 p-3'>
          <div className='mb-2 flex items-center gap-2'>
            ...
            <span className='text-sm text-white/60'>({selectedNode.type})</span>
          </div>
      ...
      <div className='overflow-auto'>
        <svg
          ...
          width='800'
          height='600'
          className='bg-background rounded-sm border border-white/10'
        />
      </div>
