...
import mimetypes
from .models import (
    Node, Edge, FileInfo, FileContent, FunctionSummary, 
    RepositorySummary, RepoGraphResponse, EnhancedRepoGraphResponse,
    NodeType, EdgeType
)
...
class CodeParser:
    ...
    def parse_javascript_file(self, file_path: str, content: str) -> List[FunctionSummary]:
                ...
                if ext in self.parser.supported_extensions:
                    try:
                        ...
                        files.append(FileInfo(
                            ...
                            size=stat.st_size,
                            language=self.parser.get_language_from_extension(str(file_path))
                        ))
                    except Exception as e:
